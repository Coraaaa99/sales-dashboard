...
try:
    ...
    FILE_PATH = "historical_data.csv" # 你的云端数据库文件名
...
if not historical_df.empty:
    ...
    st.info("💡 云端数据库目前为空，请管理员在上方上传数据报表以初始化数据库。")
